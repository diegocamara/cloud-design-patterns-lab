...
@SpringBootTest(
    ...
    properties = {"server.tomcat.threads.max=10", "server.tomcat.threads.min-spare=10"})
public class ShippingQuoteDefaultBulkheadHttpTest {
  ...
  @Test
  void shouldAllowAllRequestsWhenBulkheadCapacityIsSufficient() {
    ...
    try (ExecutorService executorService = Executors.newFixedThreadPool(totalRequests)) {
      ...
      assertEquals(10, availableQuotes);
      assertEquals(10, this.fakeShippingQuoteGateway.startedCalls());
    }
  }
}
